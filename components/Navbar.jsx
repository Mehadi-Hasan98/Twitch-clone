  ...
  return (
    <div className='fixed h-14  w-full flex-nowrap items-center p-4 bg-[#0e0e10] mb-[2px] z-10'>
       ...
       <div onClick={handleNav} className='block md:hidden z-10 cursor-pointer'>
        ...
        {/* Mobile menu */}
        <div className={nav ? 'md:hidden fixed top-0 left-0 w-full h-screen bg-[#0e0e10] flex justify-center items-center' :
         'md:hidden fixed top-[-100%] left-0 w-full h-screen bg-[#0e0e10] flex justify-center items-center'}>
